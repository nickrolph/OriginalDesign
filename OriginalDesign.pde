...
void rocketShipTail()
{
  stroke(0);
  fill(130);
	triangle(242.5+2, 390-2+y, 235+2, 400-2+y, 250+2, 400-2+y); // side toob r triangle back
  triangle(242.5+55+2, 390-2+y, 235+55+2, 400-2+y, 250+55+2, 400-2+y);// side toob l triangle back
  ...
  triangle(242.5, 390+y, 235, 400+y, 250, 400+y); // side toob r triangle
  triangle(242.5+55, 390+y, 235+55, 400+y, 250+55, 400+y);// side toob l triangle 
